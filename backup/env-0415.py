...
class HighwayEnv(gym.Env):
    def __init__(self,
        ...
        # probability for a vehicle to be agent-controlled 
        ...
        self.observation_space = gym.spaces.Dict({
            'time_dependent': gym.spaces.Box(low=-np.inf, high=np.inf, shape=(self.T, self.N_max, self.M1 - self.M2), dtype=np.float32),
